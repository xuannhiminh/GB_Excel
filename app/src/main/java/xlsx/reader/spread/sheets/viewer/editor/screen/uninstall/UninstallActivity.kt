package xlsx.reader.spread.sheets.viewer.editor.screen.uninstall
...
import xlsx.reader.spread.sheets.viewer.editor.databinding.ActivityUninstallBinding
...
class UninstallActivity : PdfBaseActivity<ActivityUninstallBinding>() {
    ...
    override fun initListener() {
        ...
        binding.tvUninstall.setOnClickListener {
            ...
            UninstallSurveyActivity.Companion.start(this@UninstallActivity);
            finish()
        }
    }
