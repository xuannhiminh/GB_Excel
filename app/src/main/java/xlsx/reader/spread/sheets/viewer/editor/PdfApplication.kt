package xlsx.reader.spread.sheets.viewer.editor
...
import xlsx.reader.spread.sheets.viewer.editor.common.LocaleManager
import xlsx.reader.spread.sheets.viewer.editor.di.appModule
...
//                )
    ...
    private fun initLanguage() {
        if (TextUtils.isEmpty(PreferencesHelper.getString(PreferencesHelper.KEY_LANGUAGE))) {
            xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.getInstance(this).prefLanguage =
                xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.LANGUAGE_DEFAULT
            val currentLanguage = resources.configuration.locales.get(0).language
            for (i in xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.lstCodeLanguage.indices) {
                if (currentLanguage == xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.lstCodeLanguage[i]) {
