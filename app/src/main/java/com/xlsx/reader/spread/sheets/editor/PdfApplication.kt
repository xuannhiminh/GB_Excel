package com.xlsx.reader.spread.sheets.viewer.editor
...
import com.xlsx.reader.spread.sheets.viewer.editor.common.LocaleManager
import com.xlsx.reader.spread.sheets.viewer.editor.di.appModule
...
import com.xlsx.reader.spread.sheets.viewer.editor.screen.language.PreferencesHelper
import com.xlsx.reader.spread.sheets.viewer.editor.screen.start.SplashActivity
...
//                )
    ...
    override fun getListTestDeviceId(): MutableList<String>? {
        return listOf("9C9F13F96407265FD1AD8B7217DFBB4F", "19CF3EF910710E71DA25CC42219EC340", "21EA4B3FCEDFE792A5CE1655F1B92B1F", "6877F63B09F390A8A9C2FBF6C0A89106",
            "DB2BB2022DEE9BB6351662532A8F6F05","7BF8EBE42FEB24B9C0231207C37B53FD", "87BCCFEB97F85D17C4D63F0257B0CBE5","927F922EDD0A2745773762A0363B0D96", "ABAC7807ECC8F567C2DD8FB6F3531816") as MutableList<String>?
    }
    ...
    private fun initLanguage() {
        if (TextUtils.isEmpty(PreferencesHelper.getString(PreferencesHelper.KEY_LANGUAGE))) {
            com.xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.getInstance(this).prefLanguage =
                com.xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.LANGUAGE_DEFAULT
            val currentLanguage = resources.configuration.locales.get(0).language
            for (i in com.xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.lstCodeLanguage.indices) {
                if (currentLanguage == com.xlsx.reader.spread.sheets.viewer.editor.screen.language.LocaleManager.lstCodeLanguage[i]) {
